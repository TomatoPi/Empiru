...
public:
  ...
  SpriteSheet(SDL_Renderer *r, SDL_Texture *&&t, int w, int h,
  ...
  static std::shared_ptr<SpriteSheet> loadFromFile(const std::string &path,
  ...
  ///
  /// \throw runtime_error on failure
  void renderFrame(unsigned int row, unsigned int col, const SDL_Rect *dest);
