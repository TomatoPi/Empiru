...
public:
  ...
  typedef std::unordered_set<Object::Pointer, std::hash<Object::Pointer>,
      std::equal_to<Object::Pointer>> Content;
...
public:
  ...
  void insert(const Object::Pointer &ptr) noexcept {
    bool success(_content.insert(ptr).second);
    assert(success);
  }
  /// \brief Remove given object from the tile
  void erase(const Object::Pointer &ptr) noexcept {
