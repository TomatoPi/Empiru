...
public:
  ...
  virtual ~ACameraCtrl() noexcept = default;
...
protected:
  ...
  ACameraCtrl(float hs, float vs, int nors) noexcept :
      _hScrollSpeed(hs), _vScrollSpeed(vs), _scrollH(0), _scrollV(0), _orientation(
          0), _nors(nors) {
  }
