...
namespace alloc {
  ...
  public:
    ...
    virtual U*       asPtr() noexcept       { return &_obj; }
    virtual const U* asPtr() const noexcept { return &_obj; }
    virtual U&       asRef() noexcept       { return _obj; }
    virtual const U& asRef() const noexcept { return _obj; }
