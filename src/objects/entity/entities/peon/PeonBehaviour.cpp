...
void PeonBehaviour::operator() (Entity& entity, Pointer ptr) noexcept {
  ...
  if (peon.mover().status() == decorators::Mover::Status::TargetReached) {
...
void PeonBehaviour::tick(WorldObject& obj, WorldPtr& ptr, IWorldMap& world) {
...
void PeonBehaviour::build(Peon& peon, WorldPtr& ptr, IWorldMap& world) {
...
/// \brief compute harvest order
void PeonBehaviour::supply(Peon& peon, WorldPtr& ptr, IWorldMap& world) {
...
/// \brief compute harvest order
void PeonBehaviour::store(Peon& peon, WorldPtr& ptr, IWorldMap& world) {
...
/// \brief compute harvest order
void PeonBehaviour::harvest(Peon& peon, WorldPtr& ptr, IWorldMap& world) {
...
void PeonBehaviour::moveTo(Peon& peon, WorldPtr& ptr, IWorldMap& world) {
